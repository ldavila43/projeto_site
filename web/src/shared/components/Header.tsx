...
export default function Header({ toggleMenu }: { toggleMenu: () => void }) {
    ...
    const [modalMeusDadosAberto, setModalMeusDadosAberto] = useState(false);
        ...
        <>
            <header className="bg-white h-20 border-b border-gray-200 px-8 flex items-center justify-between w-full shadow-sm z-10">
                ...
                <div className="flex items-center gap-6">
                    <button 
                        onClick={() => setModalMeusDadosAberto(true)}
                        className="flex items-center gap-3 text-left hover:bg-gray-50 p-2 rounded-lg transition-colors"
            ...
            <ModalDetalhesPessoa
                isOpen={modalMeusDadosAberto}
                onClose={() => setModalMeusDadosAberto(false)}
                titulo="Meus Dados"
